            ...
            {historyList.length === 0 ? (
                ...
                <div className='history_container'>
                    <div className='history_label'>
                        <span className='watching_history_label'>Watching history</span>
                    </div>
                            ...
                            <tbody>
                                {historyList.map((movie, index) => (
                                    <tr key={movie.imdbid}>
                                        ...
                                        <td>{movie.completedAt}</td>
                                        <td>
                                            <MdDelete 
                                                className='delete_from_history_icon' 
                                                onClick={() => deleteFromHistory(movie.imdbid)}
                                            />
                                        </td>
                                    </tr>
                                ))}
